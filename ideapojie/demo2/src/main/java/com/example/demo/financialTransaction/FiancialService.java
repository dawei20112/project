...
import com.example.demo.supplier.SuppRegistrationRequest;
import com.example.demo.supplier.Supplier;
import com.example.demo.supplier.SupplierUpdateRequesr;
...
public class FiancialService {
    private final FiancialDao supplierDao;

    public FiancialService(@Qualifier("finacialJdbc") FiancialDao supplierDao) {
